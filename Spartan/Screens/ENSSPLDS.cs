...
{
    [Binding]
    public class ENSSPLDS

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ENSSPLDS", "FormName");
		//Fields
        ...
        public static WinFormsField TaxCredit = new WinFormsField("TAX-CREDIT", "TaxCredit");
        public static WinFormsField TaxableIncome = new WinFormsField("TAXABLE-INCOME", "TaxableIncome");

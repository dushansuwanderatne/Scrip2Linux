...
{
    [Binding]
    public class SPP01702

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("SPP01702", "FormName");
		//Fields
        ...
        public static WinFormsField OldRunNumber = new WinFormsField("OLD-RUN-NUMBER", "OldRunNumber");
        public static WinFormsField OldRefNumber = new WinFormsField("OLD-REF-NUMBER", "OldRefNumber");
        public static WinFormsField PrevTranType = new WinFormsField("PREV-TRAN-TYPE", "PrevTranType");
        public static WinFormsField PrevTranDate = new WinFormsField("PREV-TRAN-DATE", "PrevTranDate");
        public static WinFormsField CashAmt = new WinFormsField("CASH-AMT", "CashAmt");
        public static WinFormsField PrevCashAmt = new WinFormsField("PREV-CASH-AMT", "PrevCashAmt");
        public static WinFormsField CashDep = new WinFormsField("CASH-DEP", "CashDep");
        public static WinFormsField PrevCashDep = new WinFormsField("PREV-CASH-DEP", "PrevCashDep");

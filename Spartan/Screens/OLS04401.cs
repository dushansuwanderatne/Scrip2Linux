...
{
    [Binding]
    public class OLS04401

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("OLS04401", "FormName");
		//Fields
        ...
        public static WinFormsField SellSbnIpn = new WinFormsField("SELL-SBN-IPN", "SellSbnIpn");

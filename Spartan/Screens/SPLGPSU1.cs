...
{
    [Binding]
    public class SPLGPSU1

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("SPLGPSU1", "FormName");
		//Fields
        ...
        public static WinFormsField MenuItemBar = new WinFormsField("MENU-ITEM-BAR", "BAR.  Broker by Advisor Report Listing", "BrokerbyAdvisorReportListing");

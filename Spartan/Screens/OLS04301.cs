...
{
    [Binding]
    public class OLS04301

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("OLS04301", "FormName");
		//Fields
        ...
        public static WinFormsField ReferenceTetr = new WinFormsField("REFERENCE-TETR", "ReferenceTetr");

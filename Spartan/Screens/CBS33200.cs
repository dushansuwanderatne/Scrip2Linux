...
{
    [Binding]
    public class CBS33200

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("CBS33200", "FormName");
		//Fields
        ...
        //public static WinFormsField Code = new WinFormsField("CODE", "Code");
        //public static WinFormsField Tcd = new WinFormsField("TCD", "Tcd");
        public static WinFormsField TcdReference = new WinFormsField("TCD-REFERENCE", "TcdReference");
    }
}

...
{
    [Binding]
    public class ERS01056

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ERS01056", "FormName");
		//Fields
        ...
        public static WinFormsField InclHldWthoutEvt = new WinFormsField("INCL-HLD-WTHOUT-EVT", "InclHldWthoutEvt");

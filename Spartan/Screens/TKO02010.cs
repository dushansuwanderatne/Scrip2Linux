...
{
    [Binding]
    public class TKO02010

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("TKO02010", "FormName");
		//Fields
        ...
        public static WinFormsField StatusCode = new WinFormsField("STATUS-CODE", "StatusCode");

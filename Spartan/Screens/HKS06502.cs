...
{
    [Binding]
    public class HKS06502

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("HKS06502", "FormName");
		//Fields
        ...
        public static WinFormsField AlphaProvider = new WinFormsField("ALPHA-PROVIDER", "AlphaProvider");
    }
}

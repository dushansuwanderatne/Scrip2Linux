...
{
    [Binding]
    public class EOLTRN01

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("EOLTRN01", "FormName");
		//Fields
        ...
        public static WinFormsField PoolUnits = new WinFormsField("POOL-UNITS", "PoolUnits");

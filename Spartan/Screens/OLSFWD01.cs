...
{
    [Binding]
    public class OLSFWD01

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("OLSFWD01", "FormName");
		//Fields
        ...
        public static WinFormsField BuyBrkDesc1to28 = new WinFormsField("BUY-BRK-DESC-1TO28", "BuyBrkDesc1to28");
        ...
        public static WinFormsField BuyInstructions1 = new WinFormsField("BUY-INSTRUCTIONS-1", "BuyInstructions1");

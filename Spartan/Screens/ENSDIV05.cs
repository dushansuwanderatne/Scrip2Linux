...
{
    [Binding]
    public class ENSDIV05

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ENSDIV05", "FormName");
		//Fields
        ...
        public static WinFormsField ClsDesc = new WinFormsField("CLS-DESC", "ClsDesc");

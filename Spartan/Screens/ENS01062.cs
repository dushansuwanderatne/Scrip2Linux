...
{
    [Binding]
    public class ENS01062

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ENS01062", "FormName");
		//Fields
        ...
        public static WinFormsField HolderPostCode = new WinFormsField("HOLDER-POST-CODE", "HolderPostCode");

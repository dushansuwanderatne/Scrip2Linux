...
{
    [Binding]
    public class OLS12502

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("OLS12502", "FormName");
		//Fields
        ...
        public static WinFormsField PayAcc = new WinFormsField("PAY-ACC", "PayAcc");

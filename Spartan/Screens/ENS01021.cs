...
{
    [Binding]
    public class ENS01021

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ENS01021", "FormName");
		//Fields
        ...
        public static WinFormsField MenuItemD1 = new WinFormsField("MENU-ITEM-D1", "D1. Deceased Estate noting (1)", "DeceasedEstatenoting(1)");
        public static WinFormsField MenuItemN4 = new WinFormsField("MENU-ITEM-N4", "N4. Free format noting (4)", "Freeformatnoting(4)");
        public static WinFormsField MenuItemD2 = new WinFormsField("MENU-ITEM-D2", "D2. Deceased Estate noting (2)", "DeceasedEstatenoting(2)");
        public static WinFormsField MenuItemN5 = new WinFormsField("MENU-ITEM-N5", "N5. Free format noting (5)", "Freeformatnoting(5)");
        public static WinFormsField MenuItemD3 = new WinFormsField("MENU-ITEM-D3", "D3. Deceased Estate noting (3)", "DeceasedEstatenoting(3)");
        public static WinFormsField MenuItemM1 = new WinFormsField("MENU-ITEM-M1", "M1. Memorandum and Articles", "MemorandumandArticles");
        public static WinFormsField MenuItemD4 = new WinFormsField("MENU-ITEM-D4", "D4. Deceased Estate noting (4)", "DeceasedEstatenoting(4)");
        public static WinFormsField MenuItemD5 = new WinFormsField("MENU-ITEM-D5", "D5. Deceased Estate noting (5)", "DeceasedEstatenoting(5)");

...
{
    [Binding]
    public class HLDJSD61

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("HLDJSD61", "FormName");
		//Fields
        ...
        public static WinFormsField ZafPostAddrLine = new WinFormsField("ZAF-POST-ADDR-LINE", "ZafPostAddrLine");
        public static WinFormsField ZafPostAddrPC = new WinFormsField("ZAF-POST-ADDR-PC", "ZafPostAddrPC");
    }
}

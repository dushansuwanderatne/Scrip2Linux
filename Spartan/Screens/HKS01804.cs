...
{
    [Binding]
    public class HKS01804

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("HKS01804", "FormName");
		//Fields
        ...
        public static WinFormsField Hks01804RegSortSequence = new WinFormsField("HKS01804-REG-SORT-SEQUENCE", "Hks01804RegSortSequence");

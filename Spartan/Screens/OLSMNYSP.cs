...
{
    [Binding]
    public class OLSMNYSP

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("OLSMNYSP", "FormName");
		//Fields
        ...
        public static WinFormsField BuySplitMoney = new WinFormsField("BUY-SPLIT-MONEY", "BuySplitMoney");

...
{
    [Binding]
    public class ENSACC01

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ENSACC01", "FormName");
		//Fields
        ...
        public static WinFormsField SummaryLine = new WinFormsField("SUMMARY-LINE", "SummaryLine");

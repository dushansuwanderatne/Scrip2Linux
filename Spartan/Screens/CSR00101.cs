...
{
    [Binding]
    public class CSR00101

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("CSR00101", "FormName");
		//Fields
        ...
        public static WinFormsField UnitsLevel = new WinFormsField("UNITS-LEVEL", "UnitsLevel");

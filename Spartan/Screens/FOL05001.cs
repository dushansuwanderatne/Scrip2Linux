...
{
    [Binding]
    public class FOL05001

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("FOL05001", "FormName");
		//Fields
        ...
        public static WinFormsField MarkingAmount = new WinFormsField("MARKING-AMOUNT", "MarkingAmount");

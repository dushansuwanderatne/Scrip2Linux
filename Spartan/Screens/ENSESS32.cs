...
{
    [Binding]
    public class ENSESS32

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ENSESS32", "FormName");
		//Fields
        ...
        public static WinFormsField ReversedRunNumber = new WinFormsField("REVERSED-RUN-NUMBER", "ReversedRunNumber");
        public static WinFormsField ReversedTransNumber = new WinFormsField("REVERSED-TRANS-NUMBER", "ReversedTransNumber");

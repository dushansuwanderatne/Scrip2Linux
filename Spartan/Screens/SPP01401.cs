...
{
    [Binding]
    public class SPP01401

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("SPP01401", "FormName");
		//Fields
        ...
        public static WinFormsField DeleteAbt = new WinFormsField("DELETE-ABT", "DeleteAbt");

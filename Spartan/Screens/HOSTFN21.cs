...
{
    [Binding]
    public class HOSTFN21

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("HOSTFN21", "FormName");
		//Fields
        ...
        public static WinFormsField FormLength = new WinFormsField("FORM-LENGTH", "FormLength");

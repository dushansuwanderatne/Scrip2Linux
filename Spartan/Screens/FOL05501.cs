...
{
    [Binding]
    public class FOL05501

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("FOL05501", "FormName");
		//Fields
        ...
        public static WinFormsField ReissueAmount = new WinFormsField("REISSUE-AMOUNT", "ReissueAmount");

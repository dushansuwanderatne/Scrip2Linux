...
{
    [Binding]
    public class ERS00102

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ERS00102", "FormName");
		//Fields
        ...
        public static WinFormsField MenuItemOM = new WinFormsField("MENU-ITEM-OM", "OM.  Outstanding Money Report", "OutstandingMoneyReport");
        ...
        public static WinFormsField MenuItemMP = new WinFormsField("MENU-ITEM-MP", "MP.  Missed Payments Report", "MissedPaymentsReport");

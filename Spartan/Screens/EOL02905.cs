...
{
    [Binding]
    public class EOL02905

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("EOL02905", "FormName");
		//Fields
        ...
        public static WinFormsField UpdtAllCert = new WinFormsField("UPDT-ALL-CERT", "UpdtAllCert");

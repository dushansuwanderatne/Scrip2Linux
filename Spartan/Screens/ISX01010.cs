...
{
    [Binding]
    public class ISX01010

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ISX01010", "FormName");
		//Fields
        ...
        public static WinFormsField LitUpd = new WinFormsField("LIT-UPD", "LitUpd");
        public static WinFormsField LitEnq = new WinFormsField("LIT-ENQ", "LitEnq");
        public static WinFormsField LitCln = new WinFormsField("LIT-CLN", "LitCln");

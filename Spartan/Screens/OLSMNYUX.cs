...
{
    [Binding]
    public class OLSMNYUX

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("OLSMNYUX", "FormName");
		//Fields
        ...
        public static WinFormsField ConfirmMoney = new WinFormsField("CONFIRM-MONEY", "ConfirmMoney");

...
{
    [Binding]
    public class CBS33400

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("CBS33400", "FormName");
		//Fields
        ...
        //public static WinFormsField Mgd = new WinFormsField("MGD", "Mgd");
        public static WinFormsField MgdReference = new WinFormsField("MGD-REFERENCE", "MgdReference");
    }
}

...
{
    [Binding]
    public class ICR03002

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ICR03002", "FormName");
		//Fields
        ...
        public static WinFormsField AddAction = new WinFormsField("ADD-ACTION", "AddAction");

...
{
    [Binding]
    public class CRSKCAP2

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("CRSKCAP2", "FormName");
		//Fields
        ...
        public static WinFormsField Ratio = new WinFormsField("RATIO", "Ratio");
        //public static WinFormsField Code = new WinFormsField("CODE", "Code");

...
{
    [Binding]
    public class CFS00300

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("CFS00300", "FormName");
		//Fields
        ...
        public static WinFormsField MsgInternode = new WinFormsField("MSG-INTERNODE", "MsgInternode");
        ...
        public static WinFormsField MsgAsxDiaryGroup = new WinFormsField("MSG-ASX-DIARY-GROUP", "MsgAsxDiaryGroup");
        public static WinFormsField BillerCode = new WinFormsField("BILLER-CODE", "BillerCode");
        public static WinFormsField ReportingGroup = new WinFormsField("REPORTING-GROUP", "ReportingGroup");
        public static WinFormsField CrestParticipantID = new WinFormsField("CREST-PARTICIPANT-ID", "CrestParticipantID");
        ...
        public static WinFormsField AllowDealingAccess = new WinFormsField("ALLOW-DEALING-ACCESS", "AllowDealingAccess");

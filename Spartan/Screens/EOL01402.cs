...
{
    [Binding]
    public class EOL01402

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("EOL01402", "FormName");
		//Fields
        ...
        public static WinFormsField InterestAmount = new WinFormsField("INTEREST-AMOUNT", "InterestAmount");

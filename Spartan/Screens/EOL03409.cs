...
{
    [Binding]
    public class EOL03409

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("EOL03409", "FormName");
		//Fields
        ...
        public static WinFormsField DisposalDesc = new WinFormsField("DISPOSAL-DESC", "DisposalDesc");
        public static WinFormsField DisposalChoice = new WinFormsField("DISPOSAL-CHOICE", "DisposalChoice");
        public static WinFormsField AllowableDispChoice = new WinFormsField("ALLOWABLE-DISP-CHOICE", "AllowableDispChoice");

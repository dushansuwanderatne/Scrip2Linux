...
{
    [Binding]
    public class SPP01003

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("SPP01003", "FormName");
		//Fields
        ...
        public static WinFormsField CertificateLine = new WinFormsField("CERTIFICATE-LINE", "CertificateLine");

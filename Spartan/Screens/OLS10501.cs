...
{
    [Binding]
    public class OLS10501

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("OLS10501", "FormName");
		//Fields
        ...
        public static WinFormsField CancelledDate = new WinFormsField("CANCELLED-DATE", "CancelledDate");

...
{
    [Binding]
    public class ENSESS35

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ENSESS35", "FormName");
		//Fields
        ...
        public static WinFormsField ReversedRunNum = new WinFormsField("REVERSED-RUN-NUM", "ReversedRunNum");
        public static WinFormsField ReversedTransNum = new WinFormsField("REVERSED-TRANS-NUM", "ReversedTransNum");

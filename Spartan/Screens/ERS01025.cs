...
{
    [Binding]
    public class ERS01025

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ERS01025", "FormName");
		//Fields
        ...
        public static WinFormsField OneClassPerCatInd = new WinFormsField("1-CLASS-PER-CAT-IND", "1ClassPerCatInd");

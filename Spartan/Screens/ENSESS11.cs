...
{
    [Binding]
    public class ENSESS11

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ENSESS11", "FormName");
		//Fields
        ...
        public static WinFormsField Ensess11AwardNumber = new WinFormsField("ENSESS11-AWARD-NUMBER", "Ensess11AwardNumber");
        ...
        public static WinFormsField UnavailErrorMsg = new WinFormsField("UNAVAIL-ERROR-MSG", "UnavailErrorMsg");
        public static WinFormsField BlackoutWarngMsg = new WinFormsField("BLACKOUT-WARNG-MSG", "BlackoutWarngMsg");

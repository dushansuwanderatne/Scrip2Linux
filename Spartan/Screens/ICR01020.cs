...
{
    [Binding]
    public class ICR01020

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ICR01020", "FormName");
		//Fields
        ...
        public static WinFormsField AsxAuthTol = new WinFormsField("ASX-AUTH-TOL", "AsxAuthTol");
        public static WinFormsField AsxAuthTolID = new WinFormsField("ASX-AUTH-TOL-I-D", "AsxAuthTolID");

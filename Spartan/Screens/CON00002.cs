...
{
    [Binding]
    public class CON00002

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("CON00002", "FormName");
		//Fields
        ...
        public static WinFormsField IssCap = new WinFormsField("ISS-CAP", "IssCap");
        public static WinFormsField ScripFormat = new WinFormsField("SCRIP-FORMAT", "ScripFormat");
    }
}

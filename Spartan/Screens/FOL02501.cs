...
{
    [Binding]
    public class FOL02501

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("FOL02501", "FormName");
		//Fields
        ...
        public static WinFormsField DivestmentAmt = new WinFormsField("DIVESTMENT-AMT", "DivestmentAmt");

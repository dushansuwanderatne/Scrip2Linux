...
{
    [Binding]
    public class ADM00200

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ADM00200", "FormName");
		//Fields
        ...
        public static WinFormsField IscSessions = new WinFormsField("ISC-SESSIONS", "IscSessions");
        public static WinFormsField IscSynchronizers = new WinFormsField("ISC-SYNCHRONIZERS", "IscSynchronizers");
        public static WinFormsField IscTimers = new WinFormsField("ISC-TIMERS", "IscTimers");

...
{
    [Binding]
    public class EOL03403

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("EOL03403", "FormName");
		//Fields
        ...
        public static WinFormsField RblDispslCHDesc = new WinFormsField("RBL-DISPSL-CH-DESC", "RblDispslCHDesc");
        ...
        public static WinFormsField PymtMthdDesc = new WinFormsField("PYMT-MTHD-DESC", "PymtMthdDesc");
        ...
        public static WinFormsField ExerciseBal = new WinFormsField("EXERCISE-BAL", "ExerciseBal");
        public static WinFormsField CurrentBal = new WinFormsField("CURRENT-BAL", "CurrentBal");
        public static WinFormsField AddressLine = new WinFormsField("ADDRESS-LINE", "AddressLine");
        public static WinFormsField Warning = new WinFormsField("WARNING", "Warning");
        public static WinFormsField TotEventUnits = new WinFormsField("TOT-EVENT-UNITS", "TotEventUnits");
        public static WinFormsField TotExerciseUnits = new WinFormsField("TOT-EXERCISE-UNITS", "TotExerciseUnits");
        public static WinFormsField TotCurrentBal = new WinFormsField("TOT-CURRENT-BAL", "TotCurrentBal");

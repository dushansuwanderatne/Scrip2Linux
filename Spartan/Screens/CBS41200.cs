...
{
    [Binding]
    public class CBS41200

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("CBS41200", "FormName");
		//Fields
        ...
        public static WinFormsField Refernce = new WinFormsField("REFERNCE", "Refernce");

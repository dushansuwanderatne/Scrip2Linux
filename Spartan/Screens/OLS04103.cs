...
{
    [Binding]
    public class OLS04103

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("OLS04103", "FormName");
		//Fields
        ...
        public static WinFormsField BuyUnits = new WinFormsField("BUY-UNITS", "BuyUnits");

...
{
    [Binding]
    public class ENSESS18

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ENSESS18", "FormName");
		//Fields
        ...
        public static WinFormsField Ensess18AwardNumber = new WinFormsField("ENSESS18-AWARD-NUMBER", "Ensess18AwardNumber");

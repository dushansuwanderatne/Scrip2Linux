...
{
    [Binding]
    public class ENS01048

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ENS01048", "FormName");
		//Fields
        ...
        public static WinFormsField HistoryLine = new WinFormsField("HISTORY-LINE", "HistoryLine");

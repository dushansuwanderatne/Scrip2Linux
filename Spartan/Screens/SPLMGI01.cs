...
{
    [Binding]
    public class SPLMGI01

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("SPLMGI01", "FormName");
		//Fields
        ...
        public static WinFormsField MenuItemTds = new WinFormsField("MENU-ITEM-TDS", "TDS.    Tax Detail Statements", "TaxDetailStatements");

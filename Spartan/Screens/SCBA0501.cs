...
{
    [Binding]
    public class SCBA0501

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("SCBA0501", "FormName");
		//Fields
        ...
        public static WinFormsField OSDays = new WinFormsField("OS-DAYS", "OSDays");

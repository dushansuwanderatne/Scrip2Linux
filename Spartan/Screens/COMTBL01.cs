...
{
    [Binding]
    public class COMTBL01

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("COMTBL01", "FormName");
		//Fields
        ...
        public static WinFormsField TestCalcUnitsInput = new WinFormsField("TEST-CALC-UNITS-INPUT", "TestCalcUnitsInput");

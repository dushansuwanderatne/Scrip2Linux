...
{
    [Binding]
    public class ENSESS20

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ENSESS20", "FormName");
		//Fields
        ...
        public static WinFormsField RegisterName = new WinFormsField("REGISTER-NAME", "RegisterName");

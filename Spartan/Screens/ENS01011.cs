...
{
    [Binding]
    public class ENS01011

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ENS01011", "FormName");
		//Fields
        ...
        public static WinFormsField PayAccountDesc = new WinFormsField("PAY-ACCOUNT-DESC", "PayAccountDesc");

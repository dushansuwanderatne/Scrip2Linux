...
{
    [Binding]
    public class MSG02504

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("MSG02504", "FormName");
		//Fields


        public static WinFormsField SystemInfoDate5 = new WinFormsField("SYSTEM-INFO-DATE-5", "9", "9");
        public static WinFormsField SystemInfoTime3 = new WinFormsField("SYSTEM-INFO-TIME-3", "3", "3");

...
{
    [Binding]
    public class CCT01704

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("CCT01704", "FormName");
		//Fields
        ...
        public static WinFormsField PartSettlement = new WinFormsField("PART-SETTLEMENT", "PartSettlement");

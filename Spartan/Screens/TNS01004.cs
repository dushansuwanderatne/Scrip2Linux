...
{
    [Binding]
    public class TNS01004

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("TNS01004", "FormName");
		//Fields
        ...
        public static WinFormsField IrdChar1to2 = new WinFormsField("IRD-CHAR-1TO2", "IrdChar1to2");
        public static WinFormsField IrdChar4to6 = new WinFormsField("IRD-CHAR-4TO6", "IrdChar4to6");
        public static WinFormsField IrdChar8to10 = new WinFormsField("IRD-CHAR-8TO10", "IrdChar8to10");
        public static WinFormsField AddressLine = new WinFormsField("ADDRESS-LINE", "AddressLine");
        public static WinFormsField UnencryptedTfn = new WinFormsField("UNENCRYPTED-TFN", "UnencryptedTfn");

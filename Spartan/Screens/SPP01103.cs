...
{
    [Binding]
    public class SPP01103

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("SPP01103", "FormName");
		//Fields
        ...
        public static WinFormsField UpdateAbtInst = new WinFormsField("UPDATE-ABT-INST", "UpdateAbtInst");

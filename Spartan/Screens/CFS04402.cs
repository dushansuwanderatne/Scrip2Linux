...
{
    [Binding]
    public class CFS04402

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("CFS04402", "FormName");
		//Fields
        ...
        public static WinFormsField FileOutputMask = new WinFormsField("FILE-OUTPUT-MASK", "FileOutputMask");

...
{
    [Binding]
    public class HLDJSD51

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("HLDJSD51", "FormName");
		//Fields
        ...
        public static WinFormsField ZafBenAddrLine = new WinFormsField("ZAF-BEN-ADDR-LINE", "ZafBenAddrLine");
        public static WinFormsField ZafBenAddrPC = new WinFormsField("ZAF-BEN-ADDR-PC", "ZafBenAddrPC");
    }
}

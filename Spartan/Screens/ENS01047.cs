...
{
    [Binding]
    public class ENS01047

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ENS01047", "FormName");
		//Fields
        ...
        public static WinFormsField DealingLine = new WinFormsField("DEALING-LINE", "DealingLine");

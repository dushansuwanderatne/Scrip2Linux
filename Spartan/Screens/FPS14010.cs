...
{
    [Binding]
    public class FPS14010

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("FPS14010", "FormName");
		//Fields
        ...
        public static WinFormsField AccrualASATDate = new WinFormsField("ACCRUAL-AS-AT-DATE", "AccrualASATDate");
        public static WinFormsField BalanceASATRun = new WinFormsField("BALANCE-AS-AT-RUN", "BalanceASATRun");
        public static WinFormsField ReportTypes = new WinFormsField("REPORT-TYPES", "ReportTypes");

...
{
    [Binding]
    public class TRD24000

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("TRD24000", "FormName");
		//Fields
        ...
        public static WinFormsField EventBulkInd = new WinFormsField("EVENT-BULK-IND", "EventBulkInd");
        ...
        public static WinFormsField MultipleOF1 = new WinFormsField("MULTIPLE OF <1>", "MultipleOF<1>");

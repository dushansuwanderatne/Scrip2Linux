...
{
    [Binding]
    public class OLS11902

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("OLS11902", "FormName");
		//Fields
        ...
        public static WinFormsField PayeeInsLine1 = new WinFormsField("PAYEE-INS-LINE1", "PayeeInsLine1");
        public static WinFormsField PayeeInsLine2 = new WinFormsField("PAYEE-INS-LINE2", "PayeeInsLine2");

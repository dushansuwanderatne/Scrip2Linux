...
{
    [Binding]
    public class SPLGCP01

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("SPLGCP01", "FormName");
		//Fields
        ...
        public static WinFormsField MenuItemTcr = new WinFormsField("MENU-ITEM-TCR", "TCR.  Trailing Commission Reports", "TrailingCommissionReports");

...
{
    [Binding]
    public class ERS01058

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ERS01058", "FormName");
		//Fields
        public static WinFormsField EventNumber = new WinFormsField("EVENT-NUMKT-VAL-PRICEMBER", "EventNumber");

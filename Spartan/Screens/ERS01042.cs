...
{
    [Binding]
    public class ERS01042

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ERS01042", "FormName");
		//Fields
        ...
        public static WinFormsField CanExpTypeInd = new WinFormsField("CAN-EXP-TYPE-IND", "CanExpTypeInd");

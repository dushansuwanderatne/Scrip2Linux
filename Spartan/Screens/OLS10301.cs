...
{
    [Binding]
    public class OLS10301

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("OLS10301", "FormName");
		//Fields
        ...
        public static WinFormsField NewHolderNameKey = new WinFormsField("NEW-HOLDER-NAME-KEY", "NewHolderNameKey");

...
{
    [Binding]
    public class NOTENQ20

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("NOTENQ20", "FormName");
		//Fields
        ...
        public static WinFormsField MenuItemD1 = new WinFormsField("MENU-ITEM-D1", "D1. Deceased Estate notings", "DeceasedEstatenotings");

...
{
    [Binding]
    public class SPP01601

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("SPP01601", "FormName");
		//Fields
        ...
        public static WinFormsField WithdrawalAdjust = new WinFormsField("WITHDRAWAL-ADJUST", "WithdrawalAdjust");

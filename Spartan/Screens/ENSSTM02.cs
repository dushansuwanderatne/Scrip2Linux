...
{
    [Binding]
    public class ENSSTM02

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ENSSTM02", "FormName");
		//Fields
        ...
        public static WinFormsField BeforeDetails = new WinFormsField("BEFORE-DETAILS", "BeforeDetails");
        public static WinFormsField AfterDetails = new WinFormsField("AFTER-DETAILS", "AfterDetails");

...
{
    [Binding]
    public class OLS03302

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("OLS03302", "FormName");
		//Fields
        ...
        public static WinFormsField FromResidency = new WinFormsField("FROM-RESIDENCY", "FromResidency");
        public static WinFormsField TOResidency = new WinFormsField("TO-RESIDENCY", "TOResidency");

...
{
    [Binding]
    public class NZLOLSOT

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("NZLOLSOT", "FormName");
		//Fields
        ...
        public static WinFormsField BuyerAddress1to3 = new WinFormsField("BUYER-ADDRESS-1TO3", "BuyerAddress1to3");
        public static WinFormsField BuyerAddress4to6 = new WinFormsField("BUYER-ADDRESS-4TO6", "BuyerAddress4to6");

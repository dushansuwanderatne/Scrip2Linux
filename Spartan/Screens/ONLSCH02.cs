...
{
    [Binding]
    public class ONLSCH02

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ONLSCH02", "FormName");
		//Fields
        ...
        public static WinFormsField Residency = new WinFormsField("RESIDENCY", "Residency");
        ...
        public static WinFormsField Warning1 = new WinFormsField("WARNING-1", "Warning1");
        ...
        public static WinFormsField Warning2 = new WinFormsField("WARNING-2", "Warning2");
        ...
        public static WinFormsField Warning3 = new WinFormsField("WARNING-3", "Warning3");
        ...
        public static WinFormsField ARNominatedTxt = new WinFormsField("AR-NOMINATED-TXT", "ARNominatedTxt");
    }
}

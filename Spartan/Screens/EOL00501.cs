...
{
    [Binding]
    public class EOL00501

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("EOL00501", "FormName");
		//Fields


        public static WinFormsField HIDesc = new WinFormsField("HI-DESC", "HIDesc");
        ...
        public static WinFormsField CheckUnitsDesc = new WinFormsField("CHECK-UNITS-DESC", "CheckUnitsDesc");
        ...
        public static WinFormsField UpdateContactDets = new WinFormsField("UPDATE-CONTACT-DETS", "UpdateContactDets");
        public static WinFormsField RemoveEmailInd = new WinFormsField("REMOVE-EMAIL-IND", "RemoveEmailInd");
        ...
        public static WinFormsField CreateNewAccounts = new WinFormsField("CREATE-NEW-ACCOUNTS", "CreateNewAccounts");

...
{
    [Binding]
    public class EOL00109

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("EOL00109", "FormName");
		//Fields
        ...
        public static WinFormsField MenuItemGrt = new WinFormsField("MENU-ITEM-GRT", "GRT. Manual Grant of Options", "ManualGrantofOptions");
        public static WinFormsField MenuItemRva = new WinFormsField("MENU-ITEM-RVA", "RVA. Reversal of Grant", "ReversalofGrant");

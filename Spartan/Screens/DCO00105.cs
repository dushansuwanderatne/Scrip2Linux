...
{
    [Binding]
    public class DCO00105

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("DCO00105", "FormName");
		//Fields
        ...
        public static WinFormsField GcnCode = new WinFormsField("GCN-CODE", "GcnCode");

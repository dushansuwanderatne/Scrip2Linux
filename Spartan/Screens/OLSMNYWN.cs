...
{
    [Binding]
    public class OLSMNYWN

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("OLSMNYWN", "FormName");
		//Fields
        ...
        public static WinFormsField MoneyTraded = new WinFormsField("MONEY-TRADED", "MoneyTraded");

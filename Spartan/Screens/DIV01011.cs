...
{
    [Binding]
    public class DIV01011

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("DIV01011", "FormName");
		//Fields
        ...
        public static WinFormsField ForeignAccount = new WinFormsField("FOREIGN-ACCOUNT", "ForeignAccount");
        ...
        public static WinFormsField TopUPPostDivInd = new WinFormsField("TOP-UP-POST-DIV-IND", "TopUPPostDivInd");

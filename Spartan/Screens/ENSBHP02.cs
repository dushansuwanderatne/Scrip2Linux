...
{
    [Binding]
    public class ENSBHP02

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ENSBHP02", "FormName");
		//Fields
        ...
        public static WinFormsField TranLine = new WinFormsField("TRAN-LINE", "TranLine");

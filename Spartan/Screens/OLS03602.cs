...
{
    [Binding]
    public class OLS03602

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("OLS03602", "FormName");
		//Fields
        ...
        public static WinFormsField SellInd = new WinFormsField("SELL-IND", "SellInd");

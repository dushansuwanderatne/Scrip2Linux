...
{
    [Binding]
    public class BNK00205

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("BNK00205", "FormName");
		//Fields


        public static WinFormsField PrintBatchID = new WinFormsField("PRINT-BATCH-ID", "PrintBatchID");
        public static WinFormsField PrintingBYDesc = new WinFormsField("PRINTING-BY-DESC", "PrintingBYDesc");
        ...
        public static WinFormsField PaymentDateX = new WinFormsField("PAYMENT-DATE-X", "PaymentDateX");
        ...
        public static WinFormsField HeadingText = new WinFormsField("HEADING-TEXT", "HeadingText");

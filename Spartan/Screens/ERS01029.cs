...
{
    [Binding]
    public class ERS01029

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ERS01029", "FormName");
		//Fields
        ...
        public static WinFormsField NfxupSelection = new WinFormsField("NFXUP-SELECTION", "NfxupSelection");

...
{
    [Binding]
    public class ARS01001

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ARS01001", "FormName");
		//Fields


        public static WinFormsField CompanyUfd = new WinFormsField("COMPANY-UFD", "CompanyUfd");
        public static WinFormsField FileSelection = new WinFormsField("FILE-SELECTION", "FileSelection");

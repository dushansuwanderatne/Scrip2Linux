...
{
    [Binding]
    public class FOL05502

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("FOL05502", "FormName");
		//Fields
        ...
        public static WinFormsField SellCertNbr = new WinFormsField("SELL-CERT-NBR", "SellCertNbr");
        public static WinFormsField AddressLine = new WinFormsField("ADDRESS-LINE", "AddressLine");
        public static WinFormsField ReissueAmt = new WinFormsField("REISSUE-AMT", "ReissueAmt");

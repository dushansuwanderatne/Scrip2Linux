...
{
    [Binding]
    public class ENSESS01

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ENSESS01", "FormName");
		//Fields
        ...
        public static WinFormsField LeaverPackSentDate = new WinFormsField("LEAVER-PACK-SENT-DATE", "LeaverPackSentDate");
        ...
        public static WinFormsField EmpCommOffer = new WinFormsField("EMP-COMM-OFFER", "EmpCommOffer");
        public static WinFormsField LocationCode = new WinFormsField("LOCATION-CODE", "LocationCode");
        public static WinFormsField EmpCommStmnt = new WinFormsField("EMP-COMM-STMNT", "EmpCommStmnt");
        public static WinFormsField BusinessUnit = new WinFormsField("BUSINESS-UNIT", "BusinessUnit");
        public static WinFormsField EmpCommAdhoc = new WinFormsField("EMP-COMM-ADHOC", "EmpCommAdhoc");
        public static WinFormsField JobBand = new WinFormsField("JOB-BAND", "JobBand");
        public static WinFormsField NoticeOFMeetingnoticeOFDirection = new WinFormsField("NOTICE OF MEETING/NOTICE OF DIRECTION", "NoticeOFMeeting/noticeOFDirection");

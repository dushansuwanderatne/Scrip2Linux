...
{
    [Binding]
    public class EOL01502

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("EOL01502", "FormName");
		//Fields
        ...
        //public static WinFormsField TotalUnits = new WinFormsField("TOTAL-UNITS", "TotalUnits");
        public static WinFormsField TotalTliv = new WinFormsField("TOTAL-TLIV", "TotalTliv");

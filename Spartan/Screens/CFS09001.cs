...
{
    [Binding]
    public class CFS09001

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("CFS09001", "FormName");
		//Fields


        public static WinFormsField ExchangeCode = new WinFormsField("EXCHANGE-CODE", "ExchangeCode");
        public static WinFormsField MarketIdentifierCode = new WinFormsField("MARKET IDENTIFIER CODE", "MarketIdentifierCode");

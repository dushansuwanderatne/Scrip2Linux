...
{
    [Binding]
    public class TNS01201

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("TNS01201", "FormName");
		//Fields
        ...
        public static WinFormsField TaxFileNumbers = new WinFormsField("TAX-FILE-NUMBERS", "TaxFileNumbers");
        public static WinFormsField Abns = new WinFormsField("ABNS", "Abns");
        ...
        public static WinFormsField Hst123 = new WinFormsField("HST-123", "Hst123");
        public static WinFormsField Hst456 = new WinFormsField("HST-456", "Hst456");

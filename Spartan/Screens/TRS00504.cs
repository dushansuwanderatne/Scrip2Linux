...
{
    [Binding]
    public class TRS00504

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("TRS00504", "FormName");
		//Fields
        ...
        public static WinFormsField LoanAmt = new WinFormsField("LOAN-AMT", "LoanAmt");

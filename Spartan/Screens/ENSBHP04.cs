...
{
    [Binding]
    public class ENSBHP04

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("ENSBHP04", "FormName");
		//Fields
        ...
        public static WinFormsField OptionLine = new WinFormsField("OPTION-LINE", "OptionLine");

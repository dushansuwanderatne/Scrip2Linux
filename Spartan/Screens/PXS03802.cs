...
{
    [Binding]
    public class PXS03802

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("PXS03802", "FormName");
		//Fields
        ...
        public static WinFormsField UnitsExclude = new WinFormsField("UNITS-EXCLUDE", "UnitsExclude");

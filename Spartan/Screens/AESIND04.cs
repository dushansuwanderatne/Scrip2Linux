...
{
    [Binding]
    public class AESIND04

    {
		//Form Object
		public static WinFormsForm FormName = new WinFormsForm("AESIND04", "FormName");
		//Fields
        ...
        public static WinFormsField SchLocalNumber = new WinFormsField("SCH-LOCAL-NUMBER", "SchLocalNumber");
